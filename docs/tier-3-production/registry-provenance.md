...
For strong external examples, see [`actions/toolkit`'s npm-publish workflow](https://github.com/actions/toolkit/tree/main/.github/workflows) (publishes to npm with `--provenance`) and [`pypa/sampleproject`](https://github.com/pypa/sampleproject) for the PyPI PEP 740 pattern.
